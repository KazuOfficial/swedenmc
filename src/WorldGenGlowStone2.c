...
static int WorldGenGlowStone2_generate(WorldGenerator *self, World *var1, JavaRandom *var2,
...
static WorldGeneratorVtable WorldGenGlowStone2_vtable = {
    WorldGenGlowStone2_generate,
    WorldGenerator_noop_func_517_a,
    WorldGenerator_simple_destroy,
};

WorldGenGlowStone2 *WorldGenGlowStone2_create(void) {
    WorldGenGlowStone2 *self = (WorldGenGlowStone2 *)calloc(1, sizeof(WorldGenGlowStone2));
    self->base.vtable = &WorldGenGlowStone2_vtable;
    return self;
}
