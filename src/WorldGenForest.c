...
static int WorldGenForest_generate(WorldGenerator *self, World *var1, JavaRandom *var2, int var3,
                                   int var4, int var5) {
    (void)self;
    int var6 = JavaRandom_nextInt(var2, 3) + 5;
    int var7 = 1;

    if (var4 >= 1 && var4 + var6 + 1 <= 128) {
        int var8, var10, var11, var12;
                ...
                for (var12 = var3 - var11; var12 <= var3 + var11; ++var12) {
                    ...
                    for (int var14 = var5 - var11; var14 <= var5 + var11; ++var14) {
                        ...
                        if ((abs(var13) != var11 || abs(var15) != var11 ||
                            ...
                            !Block_opaqueCubeLookup[World_getBlockId(var1, var12, var16, var14)]) {

                            World_setBlockAndMetadata(var1, var12, var16, var14,
                                                      Block_leaves->blockID, 2);
                        }
                    }
                }
            }
...
static WorldGeneratorVtable WorldGenForest_vtable = {
    WorldGenForest_generate, WorldGenerator_noop_func_517_a, WorldGenerator_simple_destroy};

WorldGenForest *WorldGenForest_create(void) {
    WorldGenForest *self = (WorldGenForest *)calloc(1, sizeof(WorldGenForest));
    self->base.vtable = &WorldGenForest_vtable;
    return self;
}

void WorldGenForest_free(WorldGenForest *self) { free(self); }
